...
% Last Modified by GUIDE v2.5 04-May-2016 07:34:51
...
% --- Executes on key press with focus on ld and none of its controls.
function ld_KeyPressFcn(hObject, eventdata, handles)
...
% --- Executes on key press with focus on stf and none of its controls.
function stf_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to stf (see GCBO)
% eventdata  structure with the following fields (see MATLAB.UI.CONTROL.UICONTROL)
%	Key: name of the key that was pressed, in lower case
%	Character: character interpretation of the key(s) that was pressed
%	Modifier: name(s) of the modifier key(s) (i.e., control, shift) pressed
